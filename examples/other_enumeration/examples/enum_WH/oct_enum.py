...
primitive.append(Atom('H',(0,0,0)))
#primitive.set_scaled_positions([[0,0,0],[0.5,0.5,0.5]])
#primitive.set_scaled_positions([[0,0,0],[0.5,0.5,0.0]])
primitive.set_scaled_positions([[0,0,0],[0.5,0.5,0.5]])
write('prim.cif',primitive)
enumerated = enumerate_structures(primitive, range(1,6), base_species)
...
for icrystal,crystal in enumerate(enumerated):
    ...
    write('oct_%04d_vac.cif'%icrystal,crystal)
    write('oct_%04d.cif'%icrystal,atoms)
